...
class AccountServiceTest {
    ...
    void createAccountSuccess() {
       ...
       //when
        ...
        assertEquals(12L, accountDto.getUseId());
    ...
    void createFirstAccount() {
        ...
        //then
        verify(accountRepository,times(1)).save(captor.capture());
        assertEquals(15L, accountDto.getUseId());
    ...
    void successGetAccountsByUserId() {
       ...
       //when
        ...
        assertEquals(2000, accountDtos.get(1).getBalance());        assertEquals(3, accountDtos.size());
